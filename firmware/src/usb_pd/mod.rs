...
const SOURCE_CAPS_WAIT_TIMEOUT_MS: u32 = 350;
const SOURCE_CAPS_REQUERY_DELAY_MS: u32 = 250;
const SOURCE_CAPS_REQUERY_RETRY_MS: u32 = 1_000;
const SOURCE_CAPS_RECOVERY_RETRY_MS: u32 = 400;
const SOURCE_CAPS_HARD_RECOVERY_TIMEOUT_MS: u32 = 1_200;
const NO_CONTRACT_SOURCE_CAPS_REARM_TIMEOUT_MS: u32 = 1_200;
