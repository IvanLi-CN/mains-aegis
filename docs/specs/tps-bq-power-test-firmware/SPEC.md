# 独立 TPS/BQ 电源测试固件（feature 驱动屏显测试套件）
...
- `docs/specs/test-fw-audio-navigation/SPEC.md`
- `docs/specs/standalone-display-diag-firmware/SPEC.md`
- `docs/specs/regulated-output-module/SPEC.md`
- `docs/specs/regulated-output-active-protection/SPEC.md`
