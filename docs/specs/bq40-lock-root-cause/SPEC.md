...
- 若 evidence 最终指向 `termination`，本 spec 覆盖 `docs/specs/bq25792-charge-policy/SPEC.md` 里“不得改 termination current 校准”的旧非目标；其它分支不触发该放宽。
...
- `/Users/ivan/Projects/Ivan/mains-aegis/docs/specs/bq40-lock-root-cause/SPEC.md`: 持续回填证据、分流结论、参数变更与最终闭环结果。
- `/Users/ivan/Projects/Ivan/mains-aegis/docs/specs/bq25792-charge-policy/SPEC.md`: 若命中 `termination` 分支，补一条 superseded 说明，收敛旧非目标口径。
...
- `/Users/ivan/Projects/Ivan/mains-aegis/docs/specs/bq25792-charge-policy/SPEC.md`
- `/Users/ivan/Projects/Ivan/mains-aegis/docs/specs/bq40-balance-baseline-and-observability/SPEC.md`
