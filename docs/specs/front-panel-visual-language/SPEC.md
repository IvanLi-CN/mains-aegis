...
- 业务口径固定：`ChargeCard` 状态来自主线 charger state machine；首页只做 `CHG500/CHG100/RECOV -> CHG` 的紧凑映射，其余 `WAIT/FULL/WARM/TEMP/LOAD/LOCK/NOAC` 保持不变。
...
- 文档链接与引用检查：`rg -n "\]\((https?://|\.\./\.\./\.\./)" firmware/ui docs/README.md docs/specs/README.md docs/specs/front-panel-visual-language/SPEC.md`
...
- `docs/specs/README.md`: 增加 front-panel-visual-language 索引行。
