...
- 设备本体 LAN 管理 API、`GET /api/v1/settings`、LAN 写接口与 transport 收敛设计已转由 [`lan-management-convergence`](../lan-management-convergence/SPEC.md) 接管。
...
- `docs/specs/wifi-service-discovery-api-foundation/contracts/http-apis.md`: 冻结 v1 API 口径。
