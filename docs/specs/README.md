...
| ---: | --- | --- | --- | --- | --- |
| hn29u | USB-C PD/PPS sink v1 | 部分完成（4/5） | `hn29u-usb-c-pd-sink-pps/SPEC.md` | 2026-04-22 | hotplug PPS 恢复重新打开：当前同一条 PPS 电源线上仍存在“数秒恢复”与“长期卡在 `CAP?`”两条路径，先收敛稳定恢复闭环，再做时延优化 |
