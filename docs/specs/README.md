...
| ---: | --- | --- | --- | --- | --- |
| hn29u | USB-C PD/PPS sink v1 | 部分完成（4/5） | `hn29u-usb-c-pd-sink-pps/SPEC.md` | 2026-04-07 | 已完成 `usb_pd`/共享 I2C2/`BQ25792` 输入限压接线与本地 feature matrix；待 PR + review-loop + 台架风险回填 |
