...
| ---: | --- | --- | --- | --- | --- |
| ypfpu | Web management UI | 部分完成（4/5） | `ypfpu-web-management-ui/SPEC.md` | 2026-04-28 | 新增 Vite/React/Bun Web 管理端，支持多设备 Fleet 卡片总览、设备接入、单设备只读详情、API/SSE 对接与 mock 视觉验证；等待 PR / review 收敛 |
