...
| 5cvrj | BQ40 self-check abnormal state + result dialogs | 部分完成（4/5） | `5cvrj-bq40-self-check-result-dialogs/SPEC.md` | 2026-03-11 | 本地实现、预览 PNG 与文档已同步；push 前仍需主人确认图片提交 |
