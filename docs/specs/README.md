...
| ---: | --- | --- | --- | --- | --- |
| tmdtq | BQ40 tool reflash / recovery convergence | 部分完成（4/5） | `tmdtq-bq40-tool-reflash-recovery/SPEC.md` | 2026-03-06 | 工具路径内已收敛 force-min-charge / flash_done / mac-only probe；真实 BQ40 仍处于阻断态 |
