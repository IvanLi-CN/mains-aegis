...
| ---: | --- | --- | --- | --- | --- |
| p8k3d | Mains Aegis Device Daemon | 已完成 | `p8k3d-mains-aegis-devd/SPEC.md` | 2026-05-02 | 新增 `mains-aegis-devd` 设备主入口、Firmware Catalog、固件 identity/defmt 匹配、Web dev proxy 与操作 skill |
