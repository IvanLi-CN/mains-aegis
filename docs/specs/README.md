...
| ---: | --- | --- | --- | --- | --- |
| hn29u | USB-C PD/PPS sink v1 | 已完成 | `hn29u-usb-c-pd-sink-pps/SPEC.md` | 2026-04-08 | 已完成默认全开 + blacklist feature、USB-C 协商/重协商禁充 gate、PPS keep-alive、host audit 覆盖，以及 review-loop 收敛的协议版本/5V 回落/WAIT 恢复修正 |
