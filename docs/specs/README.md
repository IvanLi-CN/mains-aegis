...
| eu2b8 | BQ25792 500mA charge policy + DC derate | 部分完成（4/5） | `eu2b8-bq25792-charge-policy/SPEC.md` | 2026-03-28 | 主线已落地 `80% / 3.70V` 启停、满充锁存、`DC5025` 独占输入 `3.0A -> 100mA` 降档与 host-side 预览场景；等待最终视觉证据晋升与 PR 收口 |
