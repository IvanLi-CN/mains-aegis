...
| h43mk | Main firmware runtime audio cues | 已完成 | `h43mk-main-firmware-runtime-audio-cues/SPEC.md` | 2026-03-13 | 主固件已切换到运行时 cue 服务；补齐 DMA hotfix，并修正必需 BMS 缺失时故障音被静默吞掉的问题 |
