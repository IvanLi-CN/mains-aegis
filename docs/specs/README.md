...
| h43mk | Main firmware runtime audio cues | archived | `h43mk-main-firmware-runtime-audio-cues/SPEC.md` | 2026-06-08 | 主固件已把 dashboard/audio 的 `ACTION / SYSTEM` 分组 gain 与独立 preview tone 接入运行时；runtime DMA underrun 收敛策略保持不变 |
