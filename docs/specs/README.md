...
| ---: | --- | --- | --- | --- | --- |
| edbpk | BQ40 Cell4 protocol-safe diagnostics | 部分完成（1/2） | `edbpk-bq40-cell4-protocol-diagnostics/SPEC.md` | 2026-03-14 | 已修正主机侧协议与侵入式诊断；当前已确认串数配置为 4 节，待补 reply PEC 校验 |
