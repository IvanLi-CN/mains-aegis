...
- Dashboard 模式切换的运行态语义引用 `docs/specs/runtime-mode-switching/SPEC.md`，本规格只保留视觉与文案冻结。
...
- Dashboard 冻结语义（视觉层）：
  ...
  - 自动运行态切换规则、`ASSIST/BACKUP` 的进入条件、以及与 charger `LOAD/NOAC` 的联动以 `docs/specs/runtime-mode-switching/SPEC.md` 为准。
...
- `docs/specs/front-panel-industrial-ui-preview/assets/dashboard-b-off-mode.png`
- `docs/specs/front-panel-industrial-ui-preview/assets/dashboard-b-standby-mode.png`
- `docs/specs/front-panel-industrial-ui-preview/assets/dashboard-b-supplement-mode.png`
- `docs/specs/front-panel-industrial-ui-preview/assets/dashboard-b-backup-mode.png`
- `docs/specs/front-panel-industrial-ui-preview/assets/self-check-c-standby-idle.png`
- `docs/specs/front-panel-industrial-ui-preview/assets/self-check-c-standby-right.png`
- `docs/specs/front-panel-industrial-ui-preview/assets/self-check-c-assist-up.png`
- `docs/specs/front-panel-industrial-ui-preview/assets/self-check-c-backup-touch.png`
- `docs/specs/front-panel-industrial-ui-preview/assets/self-check-c-bq40-offline-idle.png`
- `docs/specs/front-panel-industrial-ui-preview/assets/self-check-c-bq40-offline-activate-dialog.png`
- `docs/specs/front-panel-industrial-ui-preview/assets/self-check-c-bq40-activating.png`
- `docs/specs/front-panel-industrial-ui-preview/assets/self-check-c-bq40-activation-succeeded.png`
- `docs/specs/front-panel-industrial-ui-preview/assets/self-check-c-bq40-activation-failed.png`
