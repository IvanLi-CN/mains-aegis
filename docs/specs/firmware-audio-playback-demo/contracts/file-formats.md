...
## Demo 音频素材与产物布局（canonical spec assets + `firmware/**`）
...
本文件为本规格的**冻结契约**：后续实现以这里为准。

源素材（计划冻结闸门要求）：必须落在本规格目录下，作为“可回归”的事实依据。

```text
docs/specs/firmware-audio-playback-demo/
  assets/
    demo-playlist/
      01_*.wav
      02_*.wav
...
- 计划侧源素材：
  - `docs/specs/firmware-audio-playback-demo/assets/demo-playlist/01_sweep_pcm.wav`
  - `docs/specs/firmware-audio-playback-demo/assets/demo-playlist/02_melody_pcm2.wav`
  - `docs/specs/firmware-audio-playback-demo/assets/demo-playlist/03_sweep_pcm3.wav`
  - `docs/specs/firmware-audio-playback-demo/assets/demo-playlist/04_melody_pcm.wav`
  - `docs/specs/firmware-audio-playback-demo/assets/demo-playlist/05_sweep_pcm2.wav`
  - `docs/specs/firmware-audio-playback-demo/assets/demo-playlist/06_melody_pcm3.wav`
- 固件侧建议引用形状：
