...
- Settings 页仅对 USB CDC 连接设备开放，提供 WiFi SSID/PSK 覆盖/清除、手动充电偏好、USB session 日志级别、structured log 面板和 USB Developer Console；Developer Console 保留当前 Web Serial session 的 tx/rx frame、raw / ignored CDC 行和协议 payload，PSK 脱敏。
