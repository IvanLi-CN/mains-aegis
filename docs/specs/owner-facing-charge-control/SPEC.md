...
- 本规格接管 `manual-charge-dashboard` 中 Web/API owner-facing 充电控制真相。
- `manual-charge-dashboard` 保留前面板与 EEPROM 历史，不再作为当前 Web Power 页合同来源。
...
- `docs/specs/wifi-service-discovery-api-foundation/contracts/http-apis.md`
