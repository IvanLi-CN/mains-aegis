...
- 可写范围：WiFi SSID/PSK 覆盖或清除、手动充电偏好、设备日志级别，以及 Advanced Power 六项 staged assist/takeover 高级参数。
...
- Settings requests：`get_identity`、`get_status`、`get_settings`、`set_log_level`、`set_manual_charge_prefs`、`set_advanced_power`、`reset_advanced_power`。
